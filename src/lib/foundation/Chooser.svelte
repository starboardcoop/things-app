...
<div class="relative h-11" on:click|stopPropagation={() => {}} on:keypress={() => {}}>
    ...
    <div class:dropdownHidden class="fixed top-0 left-0 w-full h-full md:h-fit md:absolute md:top-14 bg-indigo-50 md:brutal md:hovers-static p-4 md:rounded-md flex flex-col gap-y-4 md:gap-y-2 z-50">
