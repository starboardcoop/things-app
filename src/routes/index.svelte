...
<Column spacing="0">
	...
	<Section bg="indigo-300">
		<Column spacing="16">
			...
			<Text large><a href="https://starboard.coop" class="font-bold hover:text-primary">Starboard Co-op</a> is currently developing the <b>web app</b> to support the Library of Things.</Text>
