...
<div class="z-40 flex flex-col-reverse pointer-events-none md:flex-col md:space-y-4 fixed bottom-4 md:top-4 right-4 items-end">
    <button on:click={toggle} class:selected={visible} class="h-16 w-16 rounded-full cursor-pointer pointer-events-auto appearance-none focus:outline-none focus:ring focus:ring-white bg-yellow-300 shadow-lg hover:shadow text-center p-4" bind:this={menuButton} id="menubutton" aria-haspopup="true" aria-controls="main-menu">
